...
public class ClothesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mNextBtn = (ImageButton) v.findViewById(R.id.btn_next_fragment_clothes);
        mClothesLayout = (LinearLayout) v.findViewById(R.id.layout_clothes_fragment);
    ...
    public void printAllClothes(String title,
                              String data_get,
                              String data_out) {
        ...
        lnh1.addView(createTextView("Дата получения: ",
                0,0,0,0,
                16,
                "normal"));
        lnh1.addView(createTextView(data_get,
                ...
                16,
                "normal"));
        lnh2.addView(createTextView("Дата списания: ",
                0,0,0,0,
                16,
                "normal"));
        ...
        mClothesLayout.addView(cardView);
...
//    }
    ...
    private void getListClothes(String accessToken){
        Call<List<Clothes>> call = apiIterface.getListClothes(accessToken, "application/json");
